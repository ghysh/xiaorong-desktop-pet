"""Release 1.2.0 scripts and runtime-boundary checks."""
...
def test_release_build_entry_is_fixed_to_dp_and_fail_fast() -> None:
    script = (PROJECT_ROOT / "packaging/windows/build_xiaorong_1_2_0.ps1").read_text(encoding="utf-8")
