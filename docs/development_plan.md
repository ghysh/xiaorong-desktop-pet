...
2. **Original character visual analysis** — complete.
3. **Upper-body transparent reference material** — complete; historical reference only.
4. **Plan B full-body character design** — complete.
5. **Final full-body runtime master** — complete and visually confirmed.
6. **Transparent desktop-pet window** — complete.
7. **Low-risk transform animation system** — complete.
8. **State machine and basic behavior orchestration** — complete.
9. **Interaction, tray, settings, and position persistence** — complete.
